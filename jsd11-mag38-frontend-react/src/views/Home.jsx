...
export default function Home() {
  ...
  const askAi = async (e) => {
    e.preventDefault();
    const qTrimmed = String(question || "").trim();
        ...
        {view === "user" ? (
          ...
          <section className=" p-5  flex">
            {authLoading ? (
              ...
              <div className="w-full max-w-3xl bg-white border rounded-2xl p-5 font">Please login to access Admin Section</div>
            )}
          </section>
        ) : null}
      </section>
